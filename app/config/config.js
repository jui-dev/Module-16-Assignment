...
export const JWT_SECRET = "5EC7CEFA1BE7C9354989y7t";
...
export const WEB_CACHE = false; ///application will stop caching. true = application will start caching.

export const PORT = 5050; // in which port, we want to run our application.
